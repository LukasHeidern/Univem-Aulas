...
int main(){
    ...
    while(1){
		...
		if (C_odigo != 0){
	        ...
	        if (C_odigo == 100){
	            P_total = P_total + Q_uantidade * 1.20; 
	            printf("Cachorro Quente    100         1,20 x %i\nTotal - %0.2f",Q_uantidade, 1.20 * Q_uantidade);}
	
	        else if (C_odigo == 101){
	            P_total = P_total + Q_uantidade * 1.30;
	            printf("Bauru Simples      101         1,30 x %i\nTotal - %0.2f",Q_uantidade, 1.30 * Q_uantidade);}
	
	        else if (C_odigo == 102){
	            P_total = P_total + Q_uantidade * 1.50;
	            printf("Bauru com Ovo      102         1,50 x %i\nTotal - %0.2f",Q_uantidade, 1.50 * Q_uantidade);}
	            ...
	            P_total = P_total + Q_uantidade * 1.70;
	            ...
	            P_total = P_total + Q_uantidade * 1.00;
	            printf("Refrigerante       106         1,00 x %i\nTotal - %0.2f",Q_uantidade, 1.00 * Q_uantidade);}
	        }
